...
if not ai_suggested_df.empty:
    ...
    with st.expander("📥 Import Offline AI Strategy"):
        st.write("Drag and drop a JSON strategy file generated by your Claude/ChatGPT subscription.")
        ...
        if uploaded_file is not None:
            try:
                ...
                if st.button("🚀 Execute Import Script", type="primary"):
                    with st.spinner("Writing to Google Sheets..."):
                        ...
                        try:
                            ...
                            os.remove(temp_path)
                            st.success("Strategy successfully written to the AI_Suggested_Allocation tab!")
...
# --- Drift Calculation ---
drift_df, drift_debug = calculate_drift(holdings_df, targets_df)
