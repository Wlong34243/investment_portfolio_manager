...
cost_basis: 15674.58
current_allocation: 2.56%
---
# EWZ — Investment Thesis

## Style
Emerging Market Value / High Yield / Commodity Proxy
...
- **Massive Dividend Yields:** State-owned and private Brazilian mega-caps (like Petrobras and Vale) have recently adopted incredibly aggressive dividend payout policies, often pushing the ETF's blended yield into the high single or low double digits.
- **Financial Sector Strength:** Brazilian banks (Itaú, Bradesco) are among the most profitable in the world, operating in a highly concentrated market with massive net interest margins, providing a stable backbone to the index.
- **Valuation Floor:** Trading at mid-single-digit P/E ratios, the index is so deeply discounted that a lot of the bad news (domestic politics, fiscal deficits) is already priced in. 
...
## Rotation Priority
priority: medium (requires monitoring of global FX and commodity trends)

## Exit Conditions
- The Brazilian government explicitly passes laws seizing control of Petrobras/Vale capital allocation, terminating the massive dividend payouts that form the core of the thesis.
- A severe, global deflationary recession collapses the prices of oil, iron ore, and soybeans simultaneously.
- The US Dollar enters a massive, multi-year structural bull market, permanently crushing emerging market currencies.
...
<!-- region:change_log -->
2026-07-31 08:23: Auto-sync allocation 2.56%, drift -5.44%
