...
Current allocation 0.56%. This is starter-position size. The plan:
...
- Next step: **hold starter position, build to 2-2.5% on pullbacks**.
- Add bias: on 20%+ drawdowns or AI-infrastructure de-rating events.
- Trim bias: on cap breach or multiple expansion past trigger.
