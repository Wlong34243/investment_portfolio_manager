...
# Ensure the private key value uses \n escape sequences in the string
# Note: json.dump handles this automatically if the string contains actual \n characters
...
try:
    with open('service_account.json', 'r') as f:
        data = json.load(f)
    print(f"Validation successful. client_email: {data['client_email']}")
